...
import sty from "./PlasmicButton.module.css"; // plasmic-import: CnirdxmO2aC/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: d9DoAHQj42G/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: wuJcooJjqmr/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__mwCSk)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon2Icon
                className={classNames(projectcss.all, sty.svg___2UCo1)}
                role={"img"}
              />
            ),
